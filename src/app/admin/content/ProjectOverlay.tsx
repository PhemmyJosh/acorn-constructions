  ...
  return createPortal(
    <div className="fixed inset-0 z-[90]">
      ...
      >
        ...
        <form
          action={formAction}
          // Any keystroke or file choice counts as work worth protecting.
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 border-t border-acorn-bronze/20 pt-6">
            <button
              type="submit"
              // Blocked while an oversized file is attached: submitting would
              // be refused by the framework's body limit, which is not an error
              // the page can catch.
              disabled={isPending || localError !== null}
