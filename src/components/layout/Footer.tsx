      ...
      <Container className="grid gap-12 py-16 sm:grid-cols-2 lg:grid-cols-4 lg:py-20">
        <div className="flex flex-col gap-4 sm:col-span-2 lg:col-span-1">
          ...
          <p className="text-sm leading-relaxed text-stone-400">
            Building bold, building better, one project at a time.
          </p>
          <div className="flex items-center gap-4 pt-2">
            <a
              href={company.social.facebook}
              aria-label="Acorn Constructions on Facebook"
              target="_blank"
            ...
            <a
              ...
              aria-label="Acorn Constructions on Instagram"
              target="_blank"
              rel="noopener noreferrer"
              className="flex h-9 w-9 items-center justify-center rounded-full border border-white/20 text-stone-300 transition-colors hover:border-amber-500 hover:text-amber-400"
            >
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/services/residential-construction" className="text-sm text-stone-400 transition-colors hover:text-amber-400">
            Residential Construction
          </Link>
          <Link href="/services/commercial-construction" className="text-sm text-stone-400 transition-colors hover:text-amber-400">
            Commercial Construction
          </Link>
          <Link href="/services/specialty-services" className="text-sm text-stone-400 transition-colors hover:text-amber-400">
            Specialty Services
          </Link>
        </div>
